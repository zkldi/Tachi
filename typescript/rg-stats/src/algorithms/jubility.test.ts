...
test("Jubility Tests", () => {
	...
	expect(calculate(699_999, 100, 10), "Should return 0 for scores < 700k no matter what.").toBe(
		0,
	);
});

test("Jubility Validation Tests", () => {
	...
	expectThrowsSnapshot(() => calculate(-1, 100, 10.5), "Should throw if score is negative.");
	expectThrowsSnapshot(
