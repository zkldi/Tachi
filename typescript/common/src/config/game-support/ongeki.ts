...
export const GAME_ONGEKI_CONF = {
	providedMetrics: {
		...
		platinumScore: {
			...
			formatter: FmtNum,
			goalTitleFormatter: (v) => `Get ${v.toLocaleString("en-GB")} Platinum Score on`,
			goalOutOfFormatter: (v) => v.toLocaleString("en-GB"),
			description:
	...
	derivedMetrics: {
		...
		platinumStars: {
			...
			goalTitleFormatter: (v) => `Get ${FmtStars(v as StarEnum, false)} on`,
	...
	optionalMetrics: {
		...
		damage: {
			...
			chartDependentMax: true,
			formatter: FmtNum,
			goalTitleFormatter: (v) => `Take ${v.toLocaleString("en-GB")} damage in`,
			goalOutOfFormatter: (v) => v.toLocaleString("en-GB"),
		...
		bellCount: {
			...
			chartDependentMax: true,
			formatter: FmtNum,
			goalTitleFormatter: (v) => `Get ${v.toLocaleString("en-GB")} bells in`,
			goalOutOfFormatter: (v) => v.toLocaleString("en-GB"),
		...
		totalBellCount: {
			...
			chartDependentMax: true,
			formatter: FmtNum,
			goalTitleFormatter: (v) => `Get a total bell count of ${v.toLocaleString("en-GB")} in`,
			goalOutOfFormatter: (v) => v.toLocaleString("en-GB"),
